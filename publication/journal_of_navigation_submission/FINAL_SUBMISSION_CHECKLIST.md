...
- [x] **Highway & Vibration Metrics Verified:** Highway cruise binary speed classification (80 vs. 110 km/h) ROC-AUC = 0.625, accuracy 59.47%, and negative bias ($-3.5\text{ m/s}$, $r = -0.4866$) verified. Spectral vibration correlation ($r = -0.032$, $\rho = -0.028$) across >450,000 windows verified; motorway 2.86–2.93 Hz persistent peak and corpus-wide 2.2–2.5 Hz component identified; the component is consistent with low-frequency vehicle-body/chassis dynamics, but the physical mechanism was not directly identified. Zero Random Forest or Ridge models.
